...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_folder', type=str, default=r"/home/lus04/kvmani/ml_works/kaushal_2025/outputs/data5.0/tiff/B/",
                        help='Root input folder containing images')
    parser.add_argument('--output_folder', type=str, default=r"/home/lus04/kvmani/ml_works/kaushal_2025/outputs/data5.0/tiff_for_ML/",
