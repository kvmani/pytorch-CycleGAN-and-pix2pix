...
JobList=(
  "--dataroot /home/lus04/kvmani/ml_works/kaushal_2025/outputs/data1.0/tiff_for_ML --name ebsd_data_1.0_lr1e-3 --n_epochs_decay 200 --lr 0.002"
  "--dataroot /home/lus04/kvmani/ml_works/kaushal_2025/outputs/data1.0/tiff_for_ML --name ebsd_data_1.0_lr1e-4 --n_epochs_decay 200 --lr 0.0002"
  "--dataroot /home/lus04/kvmani/ml_works/kaushal_2025/outputs/data1.0/tiff_for_ML --name ebsd_data_1.0_lr1e-5 --n_epochs_decay 200 --lr 0.00002"
)
...
for ((job_index=0; job_index<total_jobs; job_index++)); do
  ...
  train_cmd="python train.py ${job_args} --model cycle_gan --pool_size 50 --no_dropout --display_id -1 --batch_size 32 --lr 0.00002 --save_epoch_freq 20 --input_nc 3 --output_nc 3 --gpu_ids $CUDA_VISIBLE_DEVICES --preprocess none"
  
  # Filter only --dataroot and --name for the testing command
  filtered_args=$(filter_args "${job_args_array[@]}")
  test_cmd="python test.py ${filtered_args} --model cycle_gan --input_nc 1 --output_nc 1"
