...
JobList=(
  "--dataroot ./datasets/SimulatedData --name sim_kikuchi_no_preprocess_lr2e-2_decay_200 --n_epochs_decay 200 --lr 0.02"
  "--dataroot ./datasets/SimulatedData --name sim_kikuchi_no_preprocess_lr2e-2_decay_400 --n_epochs_decay 400 --lr 0.02"
  "--dataroot ./datasets/SimulatedData --name sim_kikuchi_no_preprocess_lr2e-5_decay_800 --n_epochs_decay 800 --lr 0.000002"
)
...
for ((job_index=0; job_index<total_jobs; job_index++)); do
  ...
  train_cmd="python train.py ${job_args} --model cycle_gan --pool_size 50 --no_dropout --display_id -1 --batch_size 32 --lr 0.00002 --save_epoch_freq 20 --input_nc 1 --output_nc 1 --gpu_ids $CUDA_VISIBLE_DEVICES --preprocess none"
